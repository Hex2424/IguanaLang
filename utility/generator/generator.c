...
static bool fileWriteVariablesHashmap_();
////////////////////////////////
// IMPLEMENTATION
...
static bool fileWriteVariablesHashmap_()
{
    if(Hashmap_size(&currentAst_->classVariables) != 0)
    {
        ...
        Hashmap_forEach(&currentAst_->classVariables, methodBodyVariableIteratorCallback_, NULL);
...
//         if(method->containsBody)
//         {
//             fprintf(currentCfile_, "%s_t* root", currentObjectName_);
//         }
//     }
